defmodule SymphonyElixir.CoreTest do
  ...
  test "current WORKFLOW.md file is valid and complete" do
    ...
    assert is_map(hooks)
    assert Map.get(hooks, "after_create") =~ "git clone --depth 1 git@github.com:Girolino/symphony.git ."
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_in_range(due_at_ms, retry_window_started_at_ms, 40_000, 40_500)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_in_range(due_at_ms, retry_window_started_at_ms, 10_000, 10_500)
  end
  ...
  defp assert_due_in_range(due_at_ms, retry_window_started_at_ms, min_delay_ms, max_delay_ms) do
    assert due_at_ms >= retry_window_started_at_ms + min_delay_ms
    assert due_at_ms <= retry_window_started_at_ms + max_delay_ms
  end
